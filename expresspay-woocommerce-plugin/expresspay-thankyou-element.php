<section class="woocommerce-order-details">
  <h2 class="woocommerce-order-details__title" style="margin-top: 50px !important; margin-bottom: 5px !important;"><?php echo __($detailHeader, 'wc-gateway-expresspay') ?></h2>
  <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details" style="padding-top:20px !important; padding-left: 20px !important;">
    <?php if (!empty($detailResultText)): ?>
      <li class="woocommerce-order-overview__order order">
        <?php echo __('Payment Status:', 'wc-gateway-expresspay') ?><strong><?php echo __($detailResultText, 'wc-gateway-expresspay') ?></strong>
      </li>
    <?php endif; ?>
